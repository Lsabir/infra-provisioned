...
variable "ubuntu_os_disk_size_gb" {
  description = "Size of the OS disk for the Ubuntu VM in GB."
  type        = number
  default     = 30
}

variable "ubuntu_managed_disk_type" {
  description = "Managed disk type for the Ubuntu VM OS disk."
  type        = string
  default     = "Standard_LRS"
}

variable "ubuntu_network_interface_id" {
  description = "ID of the existing network interface to attach to the Ubuntu VM."
  type        = string
}
