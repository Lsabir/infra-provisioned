# Infrastructure : nouvel-ressource-group

> Généré automatiquement par l'Agent IA DevOps

## Résumé

Création d'un groupe de ressources contenant un réseau virtuel (VNet) pour l'environnement de développement.
...
```hcl
{
  "project": "nouvel-ressource-group",
  "environment": "dev",
  "owner": "devops-team"
}
```
