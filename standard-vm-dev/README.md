# Infrastructure : standard-vm-dev

> Généré automatiquement par l'Agent IA DevOps

## Résumé

Création d'une machine virtuelle standard dans l'environnement de développement avec un réseau associé.

## Ressources Azure créées

- **NETWORK** : `standardvm-dev-network`
- **VM** : `standardvm-dev-vm`
